...
@section('content')
                                                                ...
                                                                <div class="col-12">
                                                                    <nav class="hp-gallery-area mb--20" aria-label="Product Categories">
                                                                        <div class="gallery-menu" role="tablist">
                                                                            ...
                                                                            <button data-filter=".cat-4" role="tab" aria-selected="false">Services</button>
    ...
    $maintenanceParts = array_filter($parts, function ($part) {
        return in_array($part['usage'], ['Sealing Component', 'Motion Component', 'Monitoring Component']);
                                        ...
                                        @endphp
                                                                <!-- Parts Display -->
                                                                @foreach($sprayingParts as $key => $part)
                                                                    <div class="col-lg-4 col-md-4 col-sm-6 col-12 gallery-item cat-2">
                                                                        <article class="single-service mb--30" itemscope itemtype="https://schema.org/Product">
                                                                            <div class="service-content text-center">
                                                                                <h3><a href="{{ route('parts.spraying') }}" itemprop="name">{{ $part['name'] }}</a></h3>
                                                                                <p itemprop="description">{{ $part['usage'] }}</p>
                                                                                <a href="{{ route('parts.spraying') }}" class="border-radius view-parts-link" aria-label="View details of {{ $part['name'] }}">VIEW PARTS</a>
                                                                            </div>
                                                                        </article>
                                                                    </div>
                                                                @endforeach
                                                                @foreach($maintenanceParts as $key => $part)
                                                                    <div class="col-lg-4 col-md-4 col-sm-6 col-12 gallery-item cat-2">
                                                                        <article class="single-service mb--30" itemscope itemtype="https://schema.org/Product">
                                                                            <div class="service-content text-center">
                                                                                <h3><a href="{{ route('parts.spraying') }}" itemprop="name">{{ $part['name'] }}</a></h3>
                                                                                <p itemprop="description">{{ $part['usage'] }}</p>
                                                                                <a href="{{ route('parts.maintenance') }}" class="border-radius view-parts-link"
                                                                                    aria-label="View details of {{ $part['name'] }}">VIEW PARTS</a>
                                                                            </div>
                                                                        </article>
                                                                    </div>
                                                                @endforeach
                                                                ...
                                                                @foreach ($insecticidesChemicals as $checical)
                                                                    <div class="col-lg-4 col-md-4 col-sm-6 col-12 gallery-item cat-3">
                                                                        <article class="single-service mb--30" itemscope itemtype="https://schema.org/Product">
                                                                            <div class="service-content text-center">
                                                                                <h3><a href="{{ route('products') }}" itemprop="name">{{ $checical['type'] }}</a></h3>
                                                                                <p itemprop="description">@foreach($checical['target_pests'] as $pest)
                                                                                    <span class="badge bg-secondary mr-1">{{ $pest }}</span>
                                                                                @endforeach</p>
                                                                                <meta itemprop="category" content="Chemical Solutions">
                                                                                <a href="{{ route('chemicals.insecticides') }}" class="border-radius" aria-label="View details of Pyrethrum Extract">VIEW
                                                                                    DETAILS</a>
                                                                            </div>
                                                                        </article>
                                                                    </div>
                                                                @endforeach
                                                                @foreach ($sanitizersChemicals as $checical)
                                                                    <div class="col-lg-4 col-md-4 col-sm-6 col-12 gallery-item cat-3">
                                                                        <article class="single-service mb--30" itemscope itemtype="https://schema.org/Product">
                                                                            <div class="service-content text-center">
                                                                                <h3><a href="{{ route('products') }}" itemprop="name">{{ $checical['type'] }}</a></h3>
                                                                                <p itemprop="description">@foreach($checical['applications'] as $pest)
                                                                                    <span class="badge bg-secondary mr-1">{{ $pest }}</span>
                                                                                @endforeach</p>
                                                                                <meta itemprop="category" content="Chemical Solutions">
                                                                                <a href="{{ route('chemicals.sanitizers') }}" class="border-radius"
                                                                                    aria-label="View details of Pyrethrum Extract">VIEW
                                                                                    DETAILS</a>
                                                                            </div>
                                                                        </article>
                                                                    </div>
                                                                ...
                                                                <div class="col-lg-4 col-md-4 col-sm-6 col-12 gallery-item cat-4">
                                                                    <article class="single-service mb--30" itemscope itemtype="https://schema.org/Product">
                                                                        <div class="service-content text-center">
                                                                            <h3><a href="{{ route('services') }}" itemprop="name">Equipment Maintenance</a></h3>
                                                                            <p itemprop="description">Broad spectrum insecticide for professional pest control</p>
                                                                            <meta itemprop="category" content="Chemical Solutions">
                                                                            <a href="{{ route('services') }}" class="border-radius" aria-label="View details of Deltamethrin Solution">VIEW DETAILS</a>
                                                                        </div>
                                                                    </article>
                                                                </div>
                                                                <div class="col-lg-4 col-md-4 col-sm-6 col-12 gallery-item cat-4">
                                                                    <article class="single-service mb--30" itemscope itemtype="https://schema.org/Product">
                                                                        <div class="service-content text-center">
                                                                            <h3><a href="{{ route('services') }}" itemprop="name">Equipment Repair</a></h3>
                                                                            <p itemprop="description">Broad spectrum insecticide for professional pest control</p>
                                                                            <meta itemprop="category" content="Chemical Solutions">
                                                                            <a href="{{ route('services') }}" class="border-radius" aria-label="View details of Deltamethrin Solution">VIEW DETAILS</a>
                                                                        </div>
                                                                ...
                                                                <div class="col-lg-4 col-md-4 col-sm-6 col-12 gallery-item cat-4">
                                                                    <article class="single-service mb--30" itemscope itemtype="https://schema.org/Product">
                                                                        <div class="service-content text-center">
                                                                            <h3><a href="{{ route('services') }}" itemprop="name">Technical Support</a></h3>
                                                                            <p itemprop="description">Expert technical support and consultation for your equipment.</p>
                                                                            <meta itemprop="category" content="Chemical Solutions">
                                                                            <a href="{{ route('services') }}" class="border-radius"
                                                                                aria-label="View details of Deltamethrin Solution">VIEW DETAILS</a>
                                                                        </div>
                                                                    </article>
                                                                </div>
                                                            </div>
